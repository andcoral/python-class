...
<script>
  ...
  gtag('config', 'G-Q3QPYX0WVM');
    ...
    <form class="login-form" action="https://cursos.lcg.unam.mx/login/index.php" method="post" id="login">
        ...
        <input type="hidden" name="logintoken" value="C77kCMq4aXvGsphIaDWufFRluKsxym0i">
...
M.util.help_popups.setup(Y);
 M.util.js_pending('random67cb3b489577e4'); Y.on('domready', function() { M.util.js_complete("init");  M.util.js_complete('random67cb3b489577e4'); });
})();
//]]>
</script>
